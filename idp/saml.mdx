...
For details on using SAML for authentication, see the [SAML Provider documentation](/socialaccount/providers/saml).
...
For complete SAML Service Provider documentation, see [SAML Provider](/socialaccount/providers/saml).
